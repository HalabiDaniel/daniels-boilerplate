...
const H2_CODE = `<h2 className="text-2xl md:text-4xl font-semibold text-foreground">
  Your Subheading
</h2>`;

const H3_CODE = `<h3 className="text-xl md:text-3xl font-semibold text-foreground">
  Section Heading
</h3>`;

const H4_CODE = `<h4 className="text-lg md:text-2xl font-semibold text-foreground">
  Subsection Heading
</h4>`;

const H5_CODE = `<h5 className="text-base md:text-xl font-semibold text-foreground">
  Minor Heading
</h5>`;

const H6_CODE = `<h6 className="text-sm md:text-lg font-semibold text-foreground">
  Small Heading
</h6>`;

const PARAGRAPH_CODE = `<p className="text-base md:text-[16px] md:leading-[28px] font-normal text-muted-foreground dark:text-foreground">
  Your paragraph text goes here. This is the standard body text style used throughout the application.
</p>`;

const ORDERED_LIST_CODE = `<ol className="list-decimal list-inside space-y-2 text-base text-muted-foreground dark:text-foreground">
  <li>First item in the list</li>
  <li>Second item in the list</li>
  <li>Third item in the list</li>
</ol>`;

const UNORDERED_LIST_CODE = `<ul className="list-disc list-inside space-y-2 text-base text-muted-foreground dark:text-foreground">
  ...
  return (
    <div className="space-y-6">
      ...
      <ElementCard
        ...
        code={H5_CODE}
      >
        <h5 className="text-base md:text-xl font-semibold text-foreground">
          Minor Heading
        </h5>
      </ElementCard>
      ...
      <ElementCard
        ...
        code={H6_CODE}
      >
        <h6 className="text-sm md:text-lg font-semibold text-foreground">
          Small Heading
        </h6>
      </ElementCard>
      ...
      >
        <ol className="list-decimal list-inside space-y-2 text-base text-muted-foreground dark:text-foreground">
          <li>First item in the list</li>
          <li>Second item in the list</li>
          <li>Third item in the list</li>
        </ol>
      ...
      >
        <ul className="list-disc list-inside space-y-2 text-base text-muted-foreground dark:text-foreground">
          <li>First bullet point</li>
          <li>Second bullet point</li>
          <li>Third bullet point</li>
        </ul>
